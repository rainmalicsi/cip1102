...
<body>
    ...
    $queryAdd = "INSERT INTO maranion_malicsi_books(TITLE, AUTHOR, COPYRIGHT_YEAR, PUBLICATION, CALL_NUMBER, NO_OF_COPIES) VALUES ( '$TITLE', '$AUTHOR', '$COPYRIGHT_YEAR', '$PUBLICATION', '$CALL_NUMBER', '$NO_OF_COPIES')";
